            ...
            <Card loading={loading} hoverable>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                <Avatar
                  shape="square"
                  size={54}
                  style={{ borderRadius: 12, backgroundColor: card.bg, color: card.color }}
                >
                  {card.icon}
                </Avatar>
                <div>
          ...
          <Row gutter={16}>
            <Col span={6}>
              <div>
                ...
                <Typography.Title heading={4} style={{ margin: '4px 0 0' }}>
                  {cluster.totalNodes}
                </Typography.Title>
              </div>
            </Col>
            <Col span={6}>
              <div>
                ...
                <Typography.Title
                  heading={4}
                  style={{ margin: '4px 0 0', color: 'var(--color-success-6)' }}
                >
                  {cluster.onlineNodes}
                </Typography.Title>
              </div>
            ...
            <Col span={6}>
              <div>
                ...
                <Typography.Title
                  ...
                  style={{
                    margin: '4px 0 0',
                    color: cluster.offlineNodes > 0 ? 'var(--color-danger-6)' : undefined,
                  }}
                >
            ...
            <Col span={6}>
              <div>
                ...
                <Typography.Title
                  ...
                  style={{
                    margin: '4px 0 0',
                    color: cluster.outdatedAgents > 0 ? 'var(--color-warning-6)' : undefined,
                  }}
                >
          ...
          <Table
            ...
            columns={[
              ...
              },
              {
                ...
                dataIndex: 'status',
                render: (s: string) => (
                  <Tag color={s === 'online' ? 'green' : 'red'} bordered>
                    {s === 'online' ? '在线' : '离线'}
                  </Tag>
                ),
              },
                ...
                render: (v: string, row) => {
                  ...
                  return (
                    <Space>
                      ...
                      <Tag color={color} bordered size="small">
                        {label}
                      </Tag>
                    </Space>
                  )
          ...
          <Table
            ...
            columns={[
              ...
              { title: '执行次数', dataIndex: 'totalRuns', render: (v: number) => `${v}` },
              {
                ...
                render: (_: unknown, r: NodePerformance) => (
                  <Space>
                    <Typography.Text style={{ color: 'var(--color-success-6)' }}>
                      {r.successRuns}
                    </Typography.Text>
                    <Typography.Text type="secondary">/</Typography.Text>
                    <Typography.Text
                      style={{ color: r.failedRuns > 0 ? 'var(--color-danger-6)' : undefined }}
                    >
                      {r.failedRuns}
                    </Typography.Text>
                  </Space>
          ...
          {sla.violations.length > 0 && (
            <>
              <Alert
                type="warning"
                style={{ marginTop: 16 }}
                content={`有 ${sla.violations.length} 个任务的 RPO 超标，请尽快排查：`}
              />
              <Table
                style={{ marginTop: 12 }}
          ...
          columns={[
            { title: '任务', dataIndex: 'taskName' },
            {
              ...
              render: (value: string) => {
                ...
                return label ? (
                  <Tag
                    color={value === 'success' ? 'green' : value === 'failed' ? 'red' : 'arcoblue'}
                    bordered
                  >
                    {label}
                  </Tag>
